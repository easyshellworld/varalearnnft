...
extern "C" fn init() {
    ...
    assert!(init_data.pebbles_count > 0, "Pebbles count must be greater than zero");
    ...
    match action {
        PebblesAction::Turn(pebbles) => {
            ...
            let pebbles_to_remove = if game_state.difficulty == DifficultyLevel::Easy {
                ...
                // Implement the winning strategy here for hard difficulty
                1 // For now, just remove 1 pebble as a placeholder
            };
